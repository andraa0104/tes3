        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="{{ request()->is('formpinjaman') ? 'active' : '' }}">
                        <a href="/formpinjaman"><i data-feather="layers"></i><span> Form Pinjaman</span> </a>
                    </li>
                    <li class="{{ request()->is('pengajuancuti') ? 'active' : '' }}">
                        <a href="/pengajuancuti"><i data-feather="layers"></i><span> Form Pengajuan Cuti</span> </a>
                    </li>

                    <li class="{{ request()->is('inputpegawai') ? 'active' : '' }}">
                        <a href="/inputpegawai"><i data-feather="file"></i><span> Blank Page</span> </a>
                    </li>
                    <li class="{{ request()->is('formcuti') ? 'active' : '' }}">
                        <a href="/formcuti"><i data-feather="file"></i><span> Form Cuti</span> </a>
                    </li>

                    <li class="{{ request()->is('formpenggajian') ? 'active' : '' }}">
                        <a href="/formpenggajian"><i data-feather="file"></i><span> Form Penggajian</span> </a>
                    </li>
                    <li class="{{ request()->is('formizin') ? 'active' : '' }}">
                        <a href="/formizin"><i data-feather="file"></i><span> Form Izin</span> </a>
                    </li>
                    <li class="submenu">
