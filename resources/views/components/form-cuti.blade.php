        ...
        <div class="content">
            ...
            <div class="comp-section">
                <div class="section-header">
                    <h3 class="section-title">Formulir Cuti</h3>
                    <div class="line"></div>
                </div>
                <div class="row">
                        ...
                        <div class="card-body">
                            <div id="progrss-wizard" class="twitter-bs-wizard">
                                <ul class="nav nav-tabs nav-tabs-solid  nav-justified">
                                    ...
                                    <li class="nav-item">
                                        <a href="#progress-company-document1" class="nav-link" data-toggle="tab">
                                            <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Address Detail">
                                                Pemesanan Tiket </div>
                                        </a>
                                ...
                                <div class="tab-content twitter-bs-wizard-tab-content">
                                        ...
                                        <div>
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="progresspill-email-input">Tujuan Kota</label>
                                                            <input type="email" class="form-control"
                                                                id="progresspill-email-input">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="progress-company-document1">
                                        <div>
                                            <form>
                                                <div class="row">
